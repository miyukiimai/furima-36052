...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    describe 'ユーザー新規登録' do
      ...
      it 'password:半角英数混合でないと登録できない' do
      ...
      it '全角英字でパスワードでは登録できない' do
        @user.password = 'AAA'
        @user.valid?
        expect(@user.errors.full_messages).to include('Password には全角英字では設定できません')
      end
